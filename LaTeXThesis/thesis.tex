...
RPC steht ist ein Akronym für Remote Procedure Call und bezeichnet clientseitige Funktionsaufrufe, die auf einem Server ausgeführt werden.
...
%todo: SensorDB ist Key-Value-Store
...
\end{figure}
Zu sehen ist ein MQTT-Request, also eine Anfrage des Smartphones, dass über MQTT an den Server gesendet wird.
