...
\section{Anforderungen der Lösung}\label{sec:anforderungen}
Aus den Beispielaufgaben leiten sich Anforderungen an die Lösung ab.
...
Sensorwerte müssen für deren Übermittlung initial vorliegen.
Für Sensormessungen sollten nicht auf nach einer Anfrage, sondern direkt zu Anfang gestartet werden.
Weiterhin ist zu berücksichtigen, dass die Sensorwerte einen Transportweg durchlaufen.
Dieser beschreibt die Strecke zwischen Smartphone und Programmierumgebung.
Latenzen können je nach Mobilfunk- bzw WLAN Standard, Umwelteinflüssen und der Geräteanzahl im Medium variieren.
...
Sensorwerte zwischengespeichert werden um einen Puffer aufzubauen auf den in Fällen erhöhter Latenz zugegriffen werden kann.
...
Sensormessdatenfördernde Funktionen müssen simple Rückgabewerte in Form von primitiven Datentypen zurückgeben.

Das vom Programmierer entwickelte Programm muss Ausgaben auf dem Smartphone auslösen können.
