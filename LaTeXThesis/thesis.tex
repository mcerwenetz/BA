...
\begin{abstract}
Interaktive Programmieraufgaben eignen sich besonders gut zum Programmieren lernen für angehende Programmiererinnen oder Programmierer.
Auf Mikrocontroller-Schaltungen basierende Projekte bieten durch angeschlossene Sensoren eine hohe Interaktivität, benötigen allerdings auch zusätzliches Fachwissen und müssen zusätzlich beschafft werden.
Für interaktive Aufgaben bietet der Einsatz von Smartphones Vorteile gegenüber Mikrocontroller-Schaltungen.
Die Geräte bieten einen vergleichbaren Sensorumfang und können Ausgaben virtuell darstellen.
Ihre Anbindung in Programmierumgebungen ist im Vergleich zu Mikrocontroller-Schaltungen jedoch nicht äquivalent unterstützt.

Diese Arbeit behandelt die Entwicklung einer Softwarelösung namens Smartbit, die eine Einbindung des Smartphones in Programmcode erlaubt.
Sie bietet die Möglichkeit Sensormesswerte vom Smartphone auszulesen und Ausgaben auf diesem auszuführen.
Anforderungen an Smartbit werden anhand von Beispiel-Programmieraufgaben spezifiziert und für die Implementierung berücksichtigt.
...
Die Einbindung des Smartphones in bestehenden Programmcode ist möglich.
Auftretende Latenzen zwischen Smartphone und Programm beeinträchtigen nicht die Nutzung.
Smartbit bietet eine interaktive Lernerfahrung und bietet angehenden Programmiererinnen und Programmierern einen spielerischen Einstieg in die Programmierung.
\end{abstract}
...
% Todo: JSONMEssageWrapepr wär auch gut in der Kontrollanwendung
