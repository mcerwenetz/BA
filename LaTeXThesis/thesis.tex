...
\\
Ziel dieser Arbeit ist die Entwicklung eines Frameworks, dass das Smartphone, dessen Sensoren sowie Ein- und Ausgabemöglichkeiten nutzt um kleine Softwareprojekte umzusetzen.
Zur Unterstützung werden zudem kleine Aufgabenstellungen ausgearbeitet um Lehrimpulse zu setzen.
\end{abstract}
...
\section{Server-Anwendung}\label{sec:server_arch}
