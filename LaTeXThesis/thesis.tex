...
Damit der gesamte Funktionsablauf des Frameworks korrekt funktioniert müssen Nachrichten zwischen den einzelenen Komponenten gesendet werden können.
Diese werden vorher konzipiert und berücksichtigen die in Kapitel \ref{sec:anforderungen} erwähnten Anforderungen sowohl auf Library, Middleware, und Smartphone-Seite.
...
Für die Aufrufe wurden verschiedene Nachrichtenformate definiert.
\\
...
Sie beeinhalten neben dem Typ auch noch das Feld \texttt{sensor\_type}.
