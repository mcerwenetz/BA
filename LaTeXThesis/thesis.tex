...
Der Server muss für die Vermittlung per UDP und MQTT erreichbar sein.
Dies erfordert asynchrone Reaktionen auf unterschiedliche Anfragen von unterschiedlichen Seiten.
Daher werden mehrere nebenläufige Threads verwendet die per Threadsicheren queues Aufgaben austauschen.
\\
Zur Verwendung kamen hier queues der Python-Implementierung cpython \cite{}
