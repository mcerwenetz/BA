...
Implementierte Funktionen kommunizieren zwar mit der Kontrollanwendung in Serialisierten Nachrichten, geben an die aufrufenden Programme jedoch primitive Datentypen zurück.
...
Eine, von Umgebungseigenschaften abhängige, Variierungder Übertragungsgeschwindigkeit ist dadurch für die Programmiererin oder den Programmierer nicht sichtbar.
Mit der Verwendung von MQTT und UDP wurden leichtgewichtig, ihrem Einsatzzweck entsprechende Protokolle für die Kommunikation gewählt.
